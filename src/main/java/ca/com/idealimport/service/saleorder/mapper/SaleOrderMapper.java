...
public interface SaleOrderMapper {
    ...
    default OrderItem validateAndGetOrderItem(ProductItem productItem, SaleOrderItemDto item, String itemCode, User user) {
        ...
        return OrderItem.builder()
                ...
                .subTotal(safeValue(orderItem.xs()) + safeValue(orderItem.s()) + safeValue(orderItem.xl())
                        + safeValue(orderItem.m()) + safeValue(orderItem.xl()) + safeValue(orderItem.xxl())
                        + safeValue(orderItem.xxxl()) + orderItem.mixed())
